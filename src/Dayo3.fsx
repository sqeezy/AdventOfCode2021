// taken from https://github.com/JanDotNet/AdventOfCode/blob/master/AdventOfCode2021/FSharp/Day03.fsx
...
sprintf "Solution 1: %i" (solve1 input)
sprintf "Solution 2: %i" (solve2 input)